 ...
 <nav class="bg-gradient-to-r from-blue-500 to-purple-600 text-white p-4 shadow-md">
        <div class="container mx-auto flex justify-between items-center">
            ...
            <div class="hidden md:flex space-x-4">
                <a href="./login.php" class="bg-yellow-500 text-white px-4 py-2 rounded-lg font-semibold hover:bg-yellow-600">Sign In</a>
            </div>
...
<div class="bg-gray-100 flex items-center justify-center h-screen">
    ...
    <div class="bg-white p-8 rounded-lg shadow-lg w-96" id="loginContainer">
        ...
        <form id="loginForm" action="home.php" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="name" name="name" class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Enter your FullName" required>
            </div>
            ...
            <div class="mb-6">
                ...
                <input type="password" id="password" name="password" class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Confirm password" required>
            </div>
    ...
    <div id="successMessage" class="hidden bg-white p-6 rounded-lg shadow-lg w-96 text-center">
        ...
        <h2 class="text-xl font-bold mt-4 text-green-600">Registered Successful!</h2>
        <p class="text-gray-600 mt-2">Now you can login with your credentials...!</p>
    </div>
    </div>
    <script>
